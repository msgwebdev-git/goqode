...
<xsl:stylesheet version="2.0"
  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml" lang="en">
      <head>
        <title>XML Sitemap — GoQode</title>
        <meta charset="UTF-8"/>
      ...
      <body>
        <div class="header">
          <h1>XML Sitemap</h1>
          <p>This sitemap contains all URLs for goqode.agency, used by search engines like Google, Bing, and Yandex for indexing.</p>
          <div class="stats">
            <div class="stat">
        ...
        <div class="footer">
          Generated by GoQode — <a href="https://goqode.agency">goqode.agency</a>
        </div>
      </body>
    </html>
  </xsl:template>

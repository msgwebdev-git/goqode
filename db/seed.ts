...
const CATEGORIZED_FEATURES: Record<string, Cat[]> = {
  "0": [
    { categoryKey: "designUx", features: [
      { key: "animations", price: [40, 140] },
      { key: "parallaxScrolling", price: [25, 80] },
      { key: "videoBackground", price: [40, 120] },
      { key: "darkLightTheme", price: [25, 80] },
    ]},
    { categoryKey: "leadCapture", features: [
      { key: "contactForm", price: [20, 60], recommended: true },
      { key: "emailCapture", price: [25, 80] },
      { key: "chatWidget", price: [15, 50] },
      { key: "phoneCallback", price: [15, 50] },
      { key: "quizFunnel", price: [50, 180] },
    ]},
    { categoryKey: "conversionTrust", features: [
      { key: "socialProof", price: [20, 60], recommended: true },
      { key: "faqSection", price: [10, 40] },
      { key: "pricingTable", price: [25, 80] },
      { key: "countdown", price: [15, 50] },
      { key: "abTesting", price: [50, 180] },
    ]},
    { categoryKey: "technical", features: [
      { key: "analytics", price: [30, 110], recommended: true },
      { key: "seo", price: [30, 110], recommended: true },
      { key: "speedOptimization", price: [25, 80] },
      { key: "cookieConsent", price: [15, 50] },
    ]},
  ],
  "1": [
    { categoryKey: "storefront", features: [
      { key: "productCatalog", price: [200, 600], recommended: true },
      { key: "filtersSearch", price: [150, 450], recommended: true },
      { key: "productVariants", price: [150, 350] },
      { key: "productComparison", price: [100, 250] },
      { key: "quickView", price: [80, 180] },
      { key: "wishlist", price: [100, 300] },
    ]},
    { categoryKey: "paymentsOrders", features: [
      { key: "cartCheckout", price: [300, 900], recommended: true },
      { key: "paymentGateway", price: [350, 1100], recommended: true },
      { key: "localPayments", price: [200, 600] },
      { key: "orderTracking", price: [150, 350] },
      { key: "invoiceGeneration", price: [150, 300] },
    ]},
    { categoryKey: "management", features: [
      { key: "inventory", price: [200, 650] },
      { key: "shipping", price: [180, 500] },
      { key: "promoSystem", price: [150, 450] },
      { key: "reviews", price: [100, 250] },
      { key: "multiCurrency", price: [150, 320] },
    ]},
    { categoryKey: "growth", features: [
      { key: "emailIntegration", price: [150, 350] },
      { key: "abandonedCart", price: [180, 400] },
      { key: "seo", price: [150, 350], recommended: true },
      { key: "analytics", price: [150, 350], recommended: true },
    ]},
  ],
  "2": [

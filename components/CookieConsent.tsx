              ...
              sections: [
                {
                  ...
                  description:
                    "Folosim cookie-uri pentru a asigura funcționalitățile de bază ale site-ului și pentru a vă îmbunătăți experiența online. Puteți alege pentru fiecare categorie dacă doriți să acceptați sau să refuzați cookie-urile.",
                },
                {
                  title: "Cookie-uri strict necesare",
                  description:
                    "Aceste cookie-uri sunt esențiale pentru funcționarea corectă a site-ului. Fără ele, site-ul nu ar funcționa corect.",
                ...
                },
                {
                  ...
                  description:
                    'Pentru orice întrebări legate de politica noastră privind cookie-urile, vă rugăm <a href="/ro/privacy">contactați-ne</a>.',
                },
              ],
            },
          },
              ...
              sections: [
                {
                  title: "Cookie usage",
                  description:
                    "We use cookies to ensure the basic functionalities of the website and to enhance your online experience. You can choose for each category whether you want to accept or decline cookies.",
                },
                {
                  title: "Strictly necessary cookies",
                  description:
                    "These cookies are essential for the proper functioning of the website. Without them, the website would not work correctly.",
                  linkedCategory: "necessary",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    'For any questions regarding our cookie policy, please <a href="/en/privacy">contact us</a>.',
                },
              ],
            },
          },
              ...
              sections: [
                {
                  ...
                  description:
                    "Мы используем cookie для обеспечения базовой функциональности сайта и улучшения вашего опыта. Вы можете выбрать для каждой категории, хотите ли вы принять или отклонить cookie.",
                },
                {
                  title: "Строго необходимые cookie",
                  description:
                    "Эти файлы cookie необходимы для корректной работы сайта. Без них сайт не будет работать правильно.",
                  linkedCategory: "necessary",
                },
                {
                ...
                },
                {
                  ...
                  description:
                    'По любым вопросам о нашей политике cookie, пожалуйста, <a href="/ru/privacy">свяжитесь с нами</a>.',
                },
              ],
            },
          },

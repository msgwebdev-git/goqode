    ...
    () => {
      ...
      const removeHover = () => {
        ...
        if (leaveHandlerRef.current && ref.current) {
          ref.current.removeEventListener('mouseleave', leaveHandlerRef.current);
      ...
      const armHover = () => {
        ...
        const enterHandler = () => {
          if (playingRef.current || isHoveringRef.current) return;
        ...
        hoverHandlerRef.current = enterHandler;
